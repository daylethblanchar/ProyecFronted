...
import { CategoriaBadge, Titulo, RelatedCard } from './ArticlePage.styles'
...
const StyleGuidePage = () => {
  const components = [
    {
      ...
      items: [
          ...
          preview: (
            <div
              style={{
                ...
                height: '150px',
                background:
                  'linear-gradient(135deg, rgba(142, 202, 230, 0.35) 0%, rgba(33, 158, 188, 0.3) 50%, rgba(2, 48, 71, 0.4) 100%)',
                borderRadius: '8px',
                display: 'flex',
                alignItems: 'center',
        ...
        },
        {
          ...
          preview: (
            <HeroTitle style={{ position: 'relative', fontSize: '2rem' }}>Bienvenido</HeroTitle>
          ),
        },
        {
          name: 'HeroButtonLink',
          ...
          preview: (
            <HeroButtonLink to="#" variant="primary">
              Comenzar
            </HeroButtonLink>
          ),
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          preview: <BrandText>Clarity Blog</BrandText>,
        },
        {
          name: 'NavLink',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          preview: (
            <TocToggleButton style={{ position: 'relative', margin: '0 auto' }}>☰</TocToggleButton>
          ),
        },
      ],
    },
    {
      category: 'ArticlePage Components',
      file: 'src/pages/ArticlePage.styles.js',
      items: [
        {
          name: 'Titulo',
        ...
        },
        {
          ...
          preview: (
            <RelatedCard className="card" style={{ padding: '1rem', maxWidth: '250px' }}>
      ...
      items: [
        {
          ...
          preview: (
            <FooterContainer style={{ padding: '1.5rem', marginTop: 0 }}>
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Documentación completa de todos los styled-components disponibles en la aplicación. Cada
        componente incluye una descripción, código de ejemplo y vista previa interactiva.
      </PageDescription>
          ...
          <ComponentGrid>
            {category.items.map((component, itemIdx) => (
              <ComponentCard key={itemIdx}>
                ...
                <ComponentPreview>{component.preview}</ComponentPreview>
